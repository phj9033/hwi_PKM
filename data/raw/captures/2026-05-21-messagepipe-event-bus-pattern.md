---
title: MessagePipe — High-perf Pub/Sub & Event Bus (Cysharp)
slug: 2026-05-21-messagepipe-event-bus-pattern
created_at: '2026-05-21T10:40:22+09:00'
status: draft
source_type: url
lang: ko
tags:
...
- mediator-pattern
source_url: https://github.com/Cysharp/MessagePipe
fetched_at: '2026-05-21T10:40:22+09:00'
summary: MessagePipe는 .NET과 Unity용 고성능 인메모리/분산 메시징 파이프라인으로, DI 기반의 Pub/Sub·Mediator·이벤트
  어그리게이터 패턴을 통합해 제공하는 라이브러리다. 표준 C# 이벤트보다 빠르고 Prism의 EventAggregator 대비 약 78배 빠르며
  publish당 메모리 할당이 거의 없고, 키 유무·동기/비동기·싱글톤/스코프·필터 파이프라인·구독 누수 방지용 Roslyn 분석기까지 폭넓게
  지원한다. 다만 RxSwift의 Relay와 유사하게 OnCompleted가 없어 완료 신호가 필요하면 별도 이벤트로 처리해야 하며, 본문이 중간에
  잘려 분산/IPC 관련 상세는 확인되지 않는다.
---
## TL;DR
MessagePipe는 .NET과 Unity용 고성능 인메모리/분산 메시징 파이프라인으로, DI 기반의 Pub/Sub·Mediator·이벤트 어그리게이터 패턴을 통합해 제공하는 라이브러리다. 표준 C# 이벤트보다 빠르고 Prism의 EventAggregator 대비 약 78배 빠르며 publish당 메모리 할당이 거의 없고, 키 유무·동기/비동기·싱글톤/스코프·필터 파이프라인·구독 누수 방지용 Roslyn 분석기까지 폭넓게 지원한다. 다만 RxSwift의 Relay와 유사하게 OnCompleted가 없어 완료 신호가 필요하면 별도 이벤트로 처리해야 하며, 본문이 중간에 잘려 분산/IPC 관련 상세는 확인되지 않는다.

Title: GitHub - Cysharp/MessagePipe: High performance in-memory/distributed messaging pipeline for .NET and Unity.

URL Source: https://github.com/Cysharp/MessagePipe

Markdown Content:
[![Image 1: GitHub Actions](https://github.com/Cysharp/MessagePipe/workflows/Build-Debug/badge.svg)](https://github.com/Cysharp/MessagePipe/actions)[![Image 2: Releases](https://camo.githubusercontent.com/837f3c1f05d89ffc087b93a577171619415c455107814952c62006d912bf94fd/68747470733a2f2f696d672e736869656c64732e696f2f6769746875622f72656c656173652f437973686172702f4d657373616765506970652e737667)](https://github.com/Cysharp/MessagePipe/releases)
...
[![Image 3](https://user-images.githubusercontent.com/46207/115984507-5d36da80-a5e2-11eb-9942-66602906f499.png)](https://user-images.githubusercontent.com/46207/115984507-5d36da80-a5e2-11eb-9942-66602906f499.png)

Of course, memory allocation per publish operation is less(zero).

[![Image 4](https://user-images.githubusercontent.com/46207/115814615-62542800-a430-11eb-9041-1f31c1ac8464.png)](https://user-images.githubusercontent.com/46207/115814615-62542800-a430-11eb-9041-1f31c1ac8464.png)

Also providing roslyn-analyzer to prevent subscription leak.

[![Image 5](https://user-images.githubusercontent.com/46207/117535259-da753d00-b02f-11eb-9818-0ab5ef3049b1.png)](https://user-images.githubusercontent.com/46207/117535259-da753d00-b02f-11eb-9818-0ab5ef3049b1.png)

## Getting Started

[](https://github.com/Cysharp/MessagePipe#getting-started)
For .NET, use NuGet. For Unity, please read [Unity](https://github.com/Cysharp/MessagePipe#unity) section.
...
[![Image 6: image](https://user-images.githubusercontent.com/46207/122254092-bf87c980-cf07-11eb-8bdd-039c87309db6.png)](https://user-images.githubusercontent.com/46207/122254092-bf87c980-cf07-11eb-8bdd-039c87309db6.png)

You may be confused by the number of interfaces, but many functions can be written with a similar, unified API.

## Publish/Subscribe

[](https://github.com/Cysharp/MessagePipe#publishsubscribe)
...
The before and after of execution can be changed by passing a custom filter. See the [Filter](https://github.com/Cysharp/MessagePipe#filter) section for details.
...
[](https://github.com/Cysharp/MessagePipe#isingleton-iscoped)
...
[](https://github.com/Cysharp/MessagePipe#buffered)
...
[](https://github.com/Cysharp/MessagePipe#eventfactory)
...
If you want to create event outside of DI, see [Global Provider](https://github.com/Cysharp/MessagePipe#global-provider) section.
...
[](https://github.com/Cysharp/MessagePipe#requestresponseall)
...
[](https://github.com/Cysharp/MessagePipe#subscribe-extensions)
...
[](https://github.com/Cysharp/MessagePipe#filter)
...
[](https://github.com/Cysharp/MessagePipe#managing-subscription-and-diagnostics)
...
[![Image 7: image](https://user-images.githubusercontent.com/46207/116953319-e2e41580-acc7-11eb-88c9-a4704bf3e3c9.png)](https://user-images.githubusercontent.com/46207/116953319-e2e41580-acc7-11eb-88c9-a4704bf3e3c9.png)
...
[](https://github.com/Cysharp/MessagePipe#analyzer)
...
[![Image 8](https://user-images.githubusercontent.com/46207/117535259-da753d00-b02f-11eb-9818-0ab5ef3049b1.png)](https://user-images.githubusercontent.com/46207/117535259-da753d00-b02f-11eb-9818-0ab5ef3049b1.png)
...
[![Image 9](https://user-images.githubusercontent.com/46207/117535248-d5b08900-b02f-11eb-8add-33101a71033a.png)](https://user-images.githubusercontent.com/46207/117535248-d5b08900-b02f-11eb-8add-33101a71033a.png)
...
[![Image 10](https://github.com/Cysharp/CsprojModifier/raw/master/docs/images/Screen-01.png)](https://github.com/Cysharp/CsprojModifier/raw/master/docs/images/Screen-01.png)

## IDistributedPubSub / MessagePipe.Redis

[](https://github.com/Cysharp/MessagePipe#idistributedpubsub--messagepiperedis)
...
[](https://github.com/Cysharp/MessagePipe#interprocesspubsub-iremoteasyncrequest--messagepipeinterprocess)
...
[](https://github.com/Cysharp/MessagePipe#messagepipeoptions)
...
[](https://github.com/Cysharp/MessagePipe#defaultasyncpublishstrategy)
...
[](https://github.com/Cysharp/MessagePipe#handlingsubscribedisposedpolicy)
...
[](https://github.com/Cysharp/MessagePipe#instancelifetime)
...
[](https://github.com/Cysharp/MessagePipe#requesthandlerlifetime)
...
[](https://github.com/Cysharp/MessagePipe#enableautoregistrationsetautoregistrationsearchassembliessetautoregistrationsearchtypes)
...
[](https://github.com/Cysharp/MessagePipe#enablecapturestacktrace)
See the details [Managing Subscription and Diagnostics](https://github.com/Cysharp/MessagePipe#managing-subscription-and-diagnostics) section, if `true` then capture stacktrace on Subscribe. It is useful for debugging but performance will be degraded. Default is `false` and recommended to enable only debug.

### AddGlobal***Filter

[](https://github.com/Cysharp/MessagePipe#addglobalfilter)
...
[](https://github.com/Cysharp/MessagePipe#global-provider)
...
[![Image 11: image](https://user-images.githubusercontent.com/46207/116521078-7c00de00-a90e-11eb-85c0-2c62c140c51d.png)](https://user-images.githubusercontent.com/46207/116521078-7c00de00-a90e-11eb-85c0-2c62c140c51d.png)

## Integration with other DI library

[](https://github.com/Cysharp/MessagePipe#integration-with-other-di-library)
...
[](https://github.com/Cysharp/MessagePipe#compare-with-channels)
...
If you are using Unity 2022.1 or later and VContainer 1.14.0 or later, you do not need `RegsiterMessageBroker<>`. A set of types including `ISubscriber<>`, `IPublisher<>` or its asynchronous version will be resolved automatically. Note that `IRequesthandler<>` and `IRequestAllHanlder<>` still require manual registration.
...
Also you can use `GlobalMessagePipe` and `MessagePipe Diagnostics` window. see: [Global provider](https://github.com/Cysharp/MessagePipe#global-provider) and [Managing Subscription and Diagnostics](https://github.com/Cysharp/MessagePipe#managing-subscription-and-diagnostics) section.

## License

[](https://github.com/Cysharp/MessagePipe#license)
